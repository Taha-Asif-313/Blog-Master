  ...
  return (
    <>
      ...
      <div className="information-section flex flex-col gap-5 h-auto my-32 lg:my-32 px-5 lg:px-24 ">
        <h1 className="text-5xl lg:text-7xl text-center font-bold">Benefits</h1>
        <div className="benefit py-10 border-b border-primary flex items-center lg:flex-row flex-col-reverse gap-20 w-full h-auto">
          ...
          <div className="image lg:w-[30%]">
            <img
              className="w-44 lg:w-full lg:object-contain"
              src="/creativity.png"
              alt=""
            />
          </div>
        ...
        <div className="benefit py-10 border-b border-primary flex flex-col-reverse lg:flex-row-reverse items-center gap-20 w-full h-auto">
          <div className="content w-[70%]">
            ...
            <p className="lg:text-left text-lg text-center">
              Blogging expands knowledge by researching for content, organizing
          ...
          <div className="image lg:w-[30%]">
            <img
              className="w-44 lg:w-full drop-shadow-[2px_2px_cyan] object-contain"
              src="/gainKnowledge.png"
              alt=""
            />
          </div>
        </div>
        <div className="benefit py-10 border-b border-primary flex items-center flex-col-reverse lg:flex-row gap-20 w-full h-auto">
          <div className="content w-[70%]">
            ...
            <p className="lg:text-left text-lg text-center">
              Blogs entertain and inform us with diverse content, from personal
              anecdotes to expert insights. They're like windows into different
              worlds, offering humor, knowledge, and connection in just a click.
            </p>
          </div>
          <div className="image lg:w-[30%]">
            <img
              className="w-44 lg:w-full drop-shadow-[2px_2px_3px_cyan] object-contain"
              src="/amuse.png"
              alt=""
            />
          </div>
